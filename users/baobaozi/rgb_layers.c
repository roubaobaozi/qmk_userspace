...
const rgblight_segment_t PROGMEM fkwin_layer[] = RGBLIGHT_LAYER_SEGMENTS(
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    rgblight_set_layer_state(1, layer_state_cmp(state, _FKWIN));
    /* rgblight_set_layer_state(2, layer_state_cmp(state, _QWERTY)); */
    rgblight_set_layer_state(2, layer_state_cmp(state, _NAV));
    rgblight_set_layer_state(3, layer_state_cmp(state, _NVW));
    rgblight_set_layer_state(4, layer_state_cmp(state, _SYN));
